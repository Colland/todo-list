...
/* harmony import */ var _Task__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./Task */ "./src/Task.js");
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./model */ "./src/model.js");
...
{
    let inboxTasks = _model__WEBPACK_IMPORTED_MODULE_17__["default"].getInboxTasks();
...
{
    let todayTasks = _model__WEBPACK_IMPORTED_MODULE_17__["default"].getTodayTasks();
    document.querySelector("#todoContainer").replaceChildren();
...
{
    let upcomingTasks = _model__WEBPACK_IMPORTED_MODULE_17__["default"].getUpcomingTasks();
    document.querySelector("#todoContainer").replaceChildren();
...
{
    let favoriteTasks = _model__WEBPACK_IMPORTED_MODULE_17__["default"].getFavoriteTasks();
    document.querySelector("#todoContainer").replaceChildren();
...
{
    let completedTasks = _model__WEBPACK_IMPORTED_MODULE_17__["default"].getCompletedTasks();
    document.querySelector("#todoContainer").replaceChildren();
...
{
    let projectTasks = _model__WEBPACK_IMPORTED_MODULE_17__["default"].getProjectTaskList(projectName);
...
function createAndAppendTask(task)
{
    ...
    taskDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_18__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_19__["default"])(task.dueDate), "dd-MM-yyyy");
...
function updateTasksView(projectName)
{
    ...
    else if(projectName == currentPage)
    {
        ...
        let projectTaskList = _model__WEBPACK_IMPORTED_MODULE_17__["default"].getProject(projectName).taskList;
...
function checkOrUncheckTask()
{
    ...
    let taskModel = _model__WEBPACK_IMPORTED_MODULE_17__["default"].getTask(currentTask.dataset.taskID, currentTask.dataset.taskProject);
    ...
    if(taskModel.completed == true)
    {
        ...
        taskCheck.textContent = "circle";
        _model__WEBPACK_IMPORTED_MODULE_17__["default"].checkOrUncheckTask(currentTask.dataset.taskID, currentTask.dataset.taskProject)
    }
    else
    {
        taskTitle.classList.add("taskFinished");
...
function updateNewTaskModalProjects()
{
    ...
    let projectsList = _model__WEBPACK_IMPORTED_MODULE_17__["default"].getProjectsList();
...
function newTaskSubmitted(e)
{
    ...
    else
    {
        if(currentPage == "Inbox" || currentPage == "Today" || currentPage == "Upcoming" || currentPage == "Important" || currentPage == "Completed")
        {
            let newTask = new _Task__WEBPACK_IMPORTED_MODULE_16__["default"](name, priority, date, project);
            _index__WEBPACK_IMPORTED_MODULE_15__["default"].addNewTask(newTask);
        ...
        {
            let newTask = new _Task__WEBPACK_IMPORTED_MODULE_16__["default"](name, priority, date, currentPage);
            _index__WEBPACK_IMPORTED_MODULE_15__["default"].addNewTask(newTask);
...
function deleteTask()
{
    ...
    _model__WEBPACK_IMPORTED_MODULE_17__["default"].removeTask(taskID, projectID);
}
...
function newProjectSubmitted(e)
{
    ...
    _model__WEBPACK_IMPORTED_MODULE_17__["default"].addNewProject(projectName.value);
...
function deleteProject(e)
{
    ...
    _model__WEBPACK_IMPORTED_MODULE_17__["default"].removeProject(projectName);
}
...
function updateFavorite()
{
    ...
    let task = _model__WEBPACK_IMPORTED_MODULE_17__["default"].getTask(taskID, project)
    ...
    _model__WEBPACK_IMPORTED_MODULE_17__["default"].toggleFavoriteTask(taskID, project);
